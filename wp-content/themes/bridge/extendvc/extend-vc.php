...
vc_map( array(
		...
		"params" => array(
            ...
            array(
                ...
                "dependency" => array('element' => 'type', 'value' => array('standard', 'standard_no_space', 'hover_text', 'hover_text_no_space', 'masonry', 'masonry_gallery_with_space', 'masonry_with_space','masonry_with_space_without_description', "justified_gallery"))
            ),
			array(
				"type" => "textfield",
				"holder" => "div",

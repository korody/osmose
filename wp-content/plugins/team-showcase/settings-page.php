  ...
  <tr>
    ...
    <td nowrap><table border="0" cellspacing="5" cellpadding="5">
      ...
      <tr>
        ...
        <td nowrap><?php echo $ts_labels['photo']['label']; ?> <select name="tshowcase-settings[tshowcase_single_photo_shape]" id="tshowcase-settings[tshowcase_single_photo_shape]">
